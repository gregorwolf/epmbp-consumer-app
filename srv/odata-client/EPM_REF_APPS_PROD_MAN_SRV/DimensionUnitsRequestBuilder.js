...
var DimensionUnitsRequestBuilder = /** @class */ (function (_super) {
    ...
    DimensionUnitsRequestBuilder.prototype.getByKey = function (unit) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(DimensionUnits_1.DimensionUnits, { Unit: unit });
    };
    /**
    ...
    DimensionUnitsRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(DimensionUnits_1.DimensionUnits);
    };
