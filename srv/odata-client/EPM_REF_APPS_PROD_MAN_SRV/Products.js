...
var Products = /** @class */ (function (_super) {
    ...
    Products.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(Products);
    };
    /**
    ...
    Products.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, Products);
    };
    /**
...
(function (Products) {
     ...
     */
    Products.CURRENCY_CODE = new cloud_sdk_core_1.StringField('CurrencyCode', Products, 'Edm.String');
    /**
     * Static representation of the [[id]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.ID = new cloud_sdk_core_1.StringField('Id', Products, 'Edm.String');
    /**
     * Static representation of the [[stockQuantity]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.STOCK_QUANTITY = new cloud_sdk_core_1.NumberField('StockQuantity', Products, 'Edm.Int32');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.NAME = new cloud_sdk_core_1.StringField('Name', Products, 'Edm.String');
    /**
     * Static representation of the [[description]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.DESCRIPTION = new cloud_sdk_core_1.StringField('Description', Products, 'Edm.String');
    /**
     * Static representation of the [[subCategoryId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.SUB_CATEGORY_ID = new cloud_sdk_core_1.StringField('SubCategoryId', Products, 'Edm.String');
    /**
     * Static representation of the [[subCategoryName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.SUB_CATEGORY_NAME = new cloud_sdk_core_1.StringField('SubCategoryName', Products, 'Edm.String');
    /**
     * Static representation of the [[mainCategoryId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.MAIN_CATEGORY_ID = new cloud_sdk_core_1.StringField('MainCategoryId', Products, 'Edm.String');
    /**
     * Static representation of the [[mainCategoryName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.MAIN_CATEGORY_NAME = new cloud_sdk_core_1.StringField('MainCategoryName', Products, 'Edm.String');
    /**
     * Static representation of the [[supplierId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.SUPPLIER_ID = new cloud_sdk_core_1.StringField('SupplierId', Products, 'Edm.String');
    /**
     * Static representation of the [[supplierName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.SUPPLIER_NAME = new cloud_sdk_core_1.StringField('SupplierName', Products, 'Edm.String');
    /**
     * Static representation of the [[lastModified]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.LAST_MODIFIED = new cloud_sdk_core_1.DateField('LastModified', Products, 'Edm.DateTime');
    /**
     * Static representation of the [[price]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.PRICE = new cloud_sdk_core_1.BigNumberField('Price', Products, 'Edm.Decimal');
    /**
     * Static representation of the [[dimensionHeight]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.DIMENSION_HEIGHT = new cloud_sdk_core_1.BigNumberField('DimensionHeight', Products, 'Edm.Decimal');
    /**
     * Static representation of the [[dimensionWidth]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.DIMENSION_WIDTH = new cloud_sdk_core_1.BigNumberField('DimensionWidth', Products, 'Edm.Decimal');
    /**
     * Static representation of the [[dimensionDepth]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.DIMENSION_DEPTH = new cloud_sdk_core_1.BigNumberField('DimensionDepth', Products, 'Edm.Decimal');
    /**
     * Static representation of the [[dimensionUnit]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.DIMENSION_UNIT = new cloud_sdk_core_1.StringField('DimensionUnit', Products, 'Edm.String');
    /**
     * Static representation of the [[imageUrl]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.IMAGE_URL = new cloud_sdk_core_1.StringField('ImageUrl', Products, 'Edm.String');
    /**
     * Static representation of the [[quantityUnit]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.QUANTITY_UNIT = new cloud_sdk_core_1.StringField('QuantityUnit', Products, 'Edm.String');
    /**
     * Static representation of the [[measureUnit]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.MEASURE_UNIT = new cloud_sdk_core_1.StringField('MeasureUnit', Products, 'Edm.String');
    /**
     * Static representation of the [[averageRating]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.AVERAGE_RATING = new cloud_sdk_core_1.BigNumberField('AverageRating', Products, 'Edm.Decimal');
    /**
     * Static representation of the [[ratingCount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.RATING_COUNT = new cloud_sdk_core_1.NumberField('RatingCount', Products, 'Edm.Int32');
    /**
     * Static representation of the [[weightMeasure]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.WEIGHT_MEASURE = new cloud_sdk_core_1.BigNumberField('WeightMeasure', Products, 'Edm.Decimal');
    /**
     * Static representation of the [[weightUnit]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.WEIGHT_UNIT = new cloud_sdk_core_1.StringField('WeightUnit', Products, 'Edm.String');
    /**
     * Static representation of the one-to-one navigation property [[supplier]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Products.SUPPLIER = new cloud_sdk_core_1.OneToOneLink('Supplier', Products, Suppliers_1.Suppliers);
    /**
     ...
     * All fields selector.
     */
    Products.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', Products);
    /**
