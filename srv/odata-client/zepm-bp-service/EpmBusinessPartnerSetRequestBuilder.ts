 ...
 */
export class EpmBusinessPartnerSetRequestBuilder extends RequestBuilder<EpmBusinessPartnerSet> {
  /**
  ...
  getByKey(bpId: string): GetByKeyRequestBuilder<EpmBusinessPartnerSet> {
    return new GetByKeyRequestBuilder(EpmBusinessPartnerSet, { BpId: bpId });
  }
  ...
  getAll(): GetAllRequestBuilder<EpmBusinessPartnerSet> {
    return new GetAllRequestBuilder(EpmBusinessPartnerSet);
  }
}
