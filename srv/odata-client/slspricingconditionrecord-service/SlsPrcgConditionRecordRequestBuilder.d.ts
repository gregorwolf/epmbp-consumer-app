 ...
 */
export declare class SlsPrcgConditionRecordRequestBuilder extends RequestBuilder<SlsPrcgConditionRecord> {
    /**
...
//# sourceMappingURL=SlsPrcgConditionRecordRequestBuilder.d.ts.map