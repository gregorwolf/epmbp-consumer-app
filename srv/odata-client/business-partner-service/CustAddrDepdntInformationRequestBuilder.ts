 ...
 */
export class CustAddrDepdntInformationRequestBuilder extends RequestBuilder<CustAddrDepdntInformation> {
  /**
  ...
  getByKey(customer: string, addressId: string): GetByKeyRequestBuilderV2<CustAddrDepdntInformation> {
    return new GetByKeyRequestBuilderV2(CustAddrDepdntInformation, {
      Customer: customer,
      AddressID: addressId
    });
  }
  ...
  getAll(): GetAllRequestBuilderV2<CustAddrDepdntInformation> {
    return new GetAllRequestBuilderV2(CustAddrDepdntInformation);
  }
  ...
  create(entity: CustAddrDepdntInformation): CreateRequestBuilderV2<CustAddrDepdntInformation> {
    return new CreateRequestBuilderV2(CustAddrDepdntInformation, entity);
  }
  ...
  update(entity: CustAddrDepdntInformation): UpdateRequestBuilderV2<CustAddrDepdntInformation> {
    return new UpdateRequestBuilderV2(CustAddrDepdntInformation, entity);
  }
  ...
  delete(customerOrEntity: any, addressId?: string): DeleteRequestBuilderV2<CustAddrDepdntInformation> {
    return new DeleteRequestBuilderV2(CustAddrDepdntInformation, customerOrEntity instanceof CustAddrDepdntInformation ? customerOrEntity : {
