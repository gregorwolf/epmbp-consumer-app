 ...
 */
export declare class BpIntlAddressVersionRequestBuilder extends RequestBuilder<BpIntlAddressVersion> {
    /**
...
//# sourceMappingURL=BpIntlAddressVersionRequestBuilder.d.ts.map