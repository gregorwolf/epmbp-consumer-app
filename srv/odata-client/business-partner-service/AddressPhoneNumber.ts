 ...
 */
export class AddressPhoneNumber extends Entity implements AddressPhoneNumberType {
  /**
  ...
  static builder(): EntityBuilderType<AddressPhoneNumber, AddressPhoneNumberTypeForceMandatory> {
    return Entity.entityBuilder(AddressPhoneNumber);
  }
  ...
  static customField(fieldName: string): CustomField<AddressPhoneNumber> {
    return Entity.customFieldSelector(fieldName, AddressPhoneNumber);
  }
...
export namespace AddressPhoneNumber {
   ...
   */
  export const ADDRESS_ID: StringField<AddressPhoneNumber> = new StringField('AddressID', AddressPhoneNumber, 'Edm.String');
  /**
   * Static representation of the [[person]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PERSON: StringField<AddressPhoneNumber> = new StringField('Person', AddressPhoneNumber, 'Edm.String');
  /**
   * Static representation of the [[ordinalNumber]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ORDINAL_NUMBER: StringField<AddressPhoneNumber> = new StringField('OrdinalNumber', AddressPhoneNumber, 'Edm.String');
  /**
   * Static representation of the [[destinationLocationCountry]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const DESTINATION_LOCATION_COUNTRY: StringField<AddressPhoneNumber> = new StringField('DestinationLocationCountry', AddressPhoneNumber, 'Edm.String');
  /**
   * Static representation of the [[isDefaultPhoneNumber]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const IS_DEFAULT_PHONE_NUMBER: BooleanField<AddressPhoneNumber> = new BooleanField('IsDefaultPhoneNumber', AddressPhoneNumber, 'Edm.Boolean');
  /**
   * Static representation of the [[phoneNumber]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PHONE_NUMBER: StringField<AddressPhoneNumber> = new StringField('PhoneNumber', AddressPhoneNumber, 'Edm.String');
  /**
   * Static representation of the [[phoneNumberExtension]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PHONE_NUMBER_EXTENSION: StringField<AddressPhoneNumber> = new StringField('PhoneNumberExtension', AddressPhoneNumber, 'Edm.String');
  /**
   * Static representation of the [[internationalPhoneNumber]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const INTERNATIONAL_PHONE_NUMBER: StringField<AddressPhoneNumber> = new StringField('InternationalPhoneNumber', AddressPhoneNumber, 'Edm.String');
  /**
   * Static representation of the [[phoneNumberType]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PHONE_NUMBER_TYPE: StringField<AddressPhoneNumber> = new StringField('PhoneNumberType', AddressPhoneNumber, 'Edm.String');
  /**
   * Static representation of the [[addressCommunicationRemarkText]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ADDRESS_COMMUNICATION_REMARK_TEXT: StringField<AddressPhoneNumber> = new StringField('AddressCommunicationRemarkText', AddressPhoneNumber, 'Edm.String');
  /**
   * All fields of the AddressPhoneNumber entity.
   */
  export const _allFields: Array<StringField<AddressPhoneNumber> | BooleanField<AddressPhoneNumber>> = [
   ...
   */
  export const _keyFields: Array<Field<AddressPhoneNumber>> = [AddressPhoneNumber.ADDRESS_ID, AddressPhoneNumber.PERSON, AddressPhoneNumber.ORDINAL_NUMBER];
  /**
   * Mapping of all key field names to the respective static field property AddressPhoneNumber.
   */
  export const _keys: { [keys: string]: Field<AddressPhoneNumber> } = AddressPhoneNumber._keyFields.reduce((acc: { [keys: string]: Field<AddressPhoneNumber> }, field: Field<AddressPhoneNumber>) => {
