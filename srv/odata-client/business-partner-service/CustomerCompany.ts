 ...
 */
export class CustomerCompany extends Entity implements CustomerCompanyType {
  /**
  ...
  static builder(): EntityBuilderType<CustomerCompany, CustomerCompanyTypeForceMandatory> {
    return Entity.entityBuilder(CustomerCompany);
  }
  ...
  static customField(fieldName: string): CustomField<CustomerCompany> {
    return Entity.customFieldSelector(fieldName, CustomerCompany);
  }
...
export namespace CustomerCompany {
   ...
   */
  export const CUSTOMER: StringField<CustomerCompany> = new StringField('Customer', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[companyCode]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const COMPANY_CODE: StringField<CustomerCompany> = new StringField('CompanyCode', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[aparToleranceGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const APAR_TOLERANCE_GROUP: StringField<CustomerCompany> = new StringField('APARToleranceGroup', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[accountByCustomer]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ACCOUNT_BY_CUSTOMER: StringField<CustomerCompany> = new StringField('AccountByCustomer', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[accountingClerk]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ACCOUNTING_CLERK: StringField<CustomerCompany> = new StringField('AccountingClerk', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[accountingClerkFaxNumber]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ACCOUNTING_CLERK_FAX_NUMBER: StringField<CustomerCompany> = new StringField('AccountingClerkFaxNumber', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[accountingClerkInternetAddress]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ACCOUNTING_CLERK_INTERNET_ADDRESS: StringField<CustomerCompany> = new StringField('AccountingClerkInternetAddress', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[accountingClerkPhoneNumber]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ACCOUNTING_CLERK_PHONE_NUMBER: StringField<CustomerCompany> = new StringField('AccountingClerkPhoneNumber', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[alternativePayerAccount]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ALTERNATIVE_PAYER_ACCOUNT: StringField<CustomerCompany> = new StringField('AlternativePayerAccount', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[authorizationGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const AUTHORIZATION_GROUP: StringField<CustomerCompany> = new StringField('AuthorizationGroup', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[collectiveInvoiceVariant]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const COLLECTIVE_INVOICE_VARIANT: StringField<CustomerCompany> = new StringField('CollectiveInvoiceVariant', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[customerAccountNote]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CUSTOMER_ACCOUNT_NOTE: StringField<CustomerCompany> = new StringField('CustomerAccountNote', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[customerHeadOffice]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CUSTOMER_HEAD_OFFICE: StringField<CustomerCompany> = new StringField('CustomerHeadOffice', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[customerSupplierClearingIsUsed]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CUSTOMER_SUPPLIER_CLEARING_IS_USED: BooleanField<CustomerCompany> = new BooleanField('CustomerSupplierClearingIsUsed', CustomerCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[houseBank]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const HOUSE_BANK: StringField<CustomerCompany> = new StringField('HouseBank', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[interestCalculationCode]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const INTEREST_CALCULATION_CODE: StringField<CustomerCompany> = new StringField('InterestCalculationCode', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[interestCalculationDate]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const INTEREST_CALCULATION_DATE: DateField<CustomerCompany> = new DateField('InterestCalculationDate', CustomerCompany, 'Edm.DateTime');
  /**
   * Static representation of the [[intrstCalcFrequencyInMonths]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const INTRST_CALC_FREQUENCY_IN_MONTHS: StringField<CustomerCompany> = new StringField('IntrstCalcFrequencyInMonths', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[isToBeLocallyProcessed]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const IS_TO_BE_LOCALLY_PROCESSED: BooleanField<CustomerCompany> = new BooleanField('IsToBeLocallyProcessed', CustomerCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[itemIsToBePaidSeparately]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ITEM_IS_TO_BE_PAID_SEPARATELY: BooleanField<CustomerCompany> = new BooleanField('ItemIsToBePaidSeparately', CustomerCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[layoutSortingRule]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LAYOUT_SORTING_RULE: StringField<CustomerCompany> = new StringField('LayoutSortingRule', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[paymentBlockingReason]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PAYMENT_BLOCKING_REASON: StringField<CustomerCompany> = new StringField('PaymentBlockingReason', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[paymentMethodsList]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PAYMENT_METHODS_LIST: StringField<CustomerCompany> = new StringField('PaymentMethodsList', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[paymentTerms]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PAYMENT_TERMS: StringField<CustomerCompany> = new StringField('PaymentTerms', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[paytAdviceIsSentbyEdi]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PAYT_ADVICE_IS_SENTBY_EDI: BooleanField<CustomerCompany> = new BooleanField('PaytAdviceIsSentbyEDI', CustomerCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[physicalInventoryBlockInd]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PHYSICAL_INVENTORY_BLOCK_IND: BooleanField<CustomerCompany> = new BooleanField('PhysicalInventoryBlockInd', CustomerCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[reconciliationAccount]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const RECONCILIATION_ACCOUNT: StringField<CustomerCompany> = new StringField('ReconciliationAccount', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[recordPaymentHistoryIndicator]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const RECORD_PAYMENT_HISTORY_INDICATOR: BooleanField<CustomerCompany> = new BooleanField('RecordPaymentHistoryIndicator', CustomerCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[userAtCustomer]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const USER_AT_CUSTOMER: StringField<CustomerCompany> = new StringField('UserAtCustomer', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[deletionIndicator]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const DELETION_INDICATOR: BooleanField<CustomerCompany> = new BooleanField('DeletionIndicator', CustomerCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[cashPlanningGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CASH_PLANNING_GROUP: StringField<CustomerCompany> = new StringField('CashPlanningGroup', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[knownOrNegotiatedLeave]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const KNOWN_OR_NEGOTIATED_LEAVE: StringField<CustomerCompany> = new StringField('KnownOrNegotiatedLeave', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[valueAdjustmentKey]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const VALUE_ADJUSTMENT_KEY: StringField<CustomerCompany> = new StringField('ValueAdjustmentKey', CustomerCompany, 'Edm.String');
  /**
   * Static representation of the [[customerAccountGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CUSTOMER_ACCOUNT_GROUP: StringField<CustomerCompany> = new StringField('CustomerAccountGroup', CustomerCompany, 'Edm.String');
  /**
   ...
   */
  export const _allFields: Array<StringField<CustomerCompany> | BooleanField<CustomerCompany> | DateField<CustomerCompany> | Link<CustomerCompany, CustomerCompanyText> | Link<CustomerCompany, CustomerDunning> | Link<CustomerCompany, CustomerWithHoldingTax>> = [
   ...
   */
  export const _keyFields: Array<Field<CustomerCompany>> = [CustomerCompany.CUSTOMER, CustomerCompany.COMPANY_CODE];
  /**
   * Mapping of all key field names to the respective static field property CustomerCompany.
   */
  export const _keys: { [keys: string]: Field<CustomerCompany> } = CustomerCompany._keyFields.reduce((acc: { [keys: string]: Field<CustomerCompany> }, field: Field<CustomerCompany>) => {
