 ...
 */
export declare class BpFiscalYearInformation extends EntityV2 implements BpFiscalYearInformationType {
    /**
...
export declare namespace BpFiscalYearInformation {
    /**
     * Static representation of the [[businessPartner]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BUSINESS_PARTNER: EdmTypeField<BpFiscalYearInformation, "Edm.String", false, true>;
    /**
     * Static representation of the [[businessPartnerFiscalYear]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BUSINESS_PARTNER_FISCAL_YEAR: EdmTypeField<BpFiscalYearInformation, "Edm.String", false, true>;
    /**
     * Static representation of the [[bpBalanceSheetCurrency]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_BALANCE_SHEET_CURRENCY: EdmTypeField<BpFiscalYearInformation, "Edm.String", true, true>;
    /**
     * Static representation of the [[bpAnnualStockholderMeetingDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_ANNUAL_STOCKHOLDER_MEETING_DATE: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.DateTime", true, true>;
    /**
     * Static representation of the [[bpFiscalYearStartDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_FISCAL_YEAR_START_DATE: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.DateTime", true, true>;
    /**
     * Static representation of the [[bpFiscalYearEndDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_FISCAL_YEAR_END_DATE: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.DateTime", true, true>;
    /**
     * Static representation of the [[bpFiscalYearIsClosed]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_FISCAL_YEAR_IS_CLOSED: EdmTypeField<BpFiscalYearInformation, "Edm.Boolean", true, true>;
    /**
     * Static representation of the [[bpFiscalYearClosingDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_FISCAL_YEAR_CLOSING_DATE: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.DateTime", true, true>;
    /**
     * Static representation of the [[bpFsclYrCnsldtdFinStatementDte]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_FSCL_YR_CNSLDTD_FIN_STATEMENT_DTE: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.DateTime", true, true>;
    /**
     * Static representation of the [[bpCapitalStockAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_CAPITAL_STOCK_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpIssdStockCptlAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_ISSD_STOCK_CPTL_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpPartcipnCertAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_PARTCIPN_CERT_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpEquityCapitalAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_EQUITY_CAPITAL_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpGrossPremiumAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_GROSS_PREMIUM_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpNetPremiumAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_NET_PREMIUM_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpAnnualSalesAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_ANNUAL_SALES_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpAnnualNetIncAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_ANNUAL_NET_INC_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpDividendDistrAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_DIVIDEND_DISTR_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpDebtRatioInYears]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_DEBT_RATIO_IN_YEARS: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpAnnualPnLAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_ANNUAL_PN_L_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpBalSheetTotalAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_BAL_SHEET_TOTAL_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpNumberOfEmployees]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_NUMBER_OF_EMPLOYEES: EdmTypeField<BpFiscalYearInformation, "Edm.String", true, true>;
    /**
     * Static representation of the [[bpCptlReserveAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_CPTL_RESERVE_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpLglRevnRsrvAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_LGL_REVN_RSRV_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[revnRsrvOwnStkAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const REVN_RSRV_OWN_STK_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpStatryReserveAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_STATRY_RESERVE_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpOthRevnRsrvAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_OTH_REVN_RSRV_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpPnLCarryfwdAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_PN_L_CARRYFWD_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpSuborddLbltyAmtInBalShtCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_SUBORDD_LBLTY_AMT_IN_BAL_SHT_CRCY: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpRetOnTotalCptlEmpldInPercent]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_RET_ON_TOTAL_CPTL_EMPLD_IN_PERCENT: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpDebtClearancePeriodInYears]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_DEBT_CLEARANCE_PERIOD_IN_YEARS: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpFinancingCoeffInPercent]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_FINANCING_COEFF_IN_PERCENT: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * Static representation of the [[bpEquityRatioInPercent]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BP_EQUITY_RATIO_IN_PERCENT: OrderableEdmTypeField<BpFiscalYearInformation, "Edm.Decimal", true, true>;
    /**
     * All fields of the BpFiscalYearInformation entity.
     */
    const _allFields: Array<EdmTypeField<BpFiscalYearInformation, 'Edm.String', false, true> | EdmTypeField<BpFiscalYearInformation, 'Edm.String', true, true> | OrderableEdmTypeField<BpFiscalYearInformation, 'Edm.DateTime', true, true> | EdmTypeField<BpFiscalYearInformation, 'Edm.Boolean', true, true> | OrderableEdmTypeField<BpFiscalYearInformation, 'Edm.Decimal', true, true>>;
    /**
     * All fields selector.
     */
    const ALL_FIELDS: AllFields<BpFiscalYearInformation>;
    /**
     * All key fields of the BpFiscalYearInformation entity.
     */
    const _keyFields: Array<Field<BpFiscalYearInformation, boolean, boolean>>;
    /**
     * Mapping of all key field names to the respective static field property BpFiscalYearInformation.
     */
    const _keys: {
        [keys: string]: Field<BpFiscalYearInformation, boolean, boolean>;
    };
}
