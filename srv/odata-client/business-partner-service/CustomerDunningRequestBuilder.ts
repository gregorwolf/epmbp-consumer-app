...
export class CustomerDunningRequestBuilder extends RequestBuilder<CustomerDunning> {
  ...
  getByKey(customer: string, companyCode: string, dunningArea: string): GetByKeyRequestBuilder<CustomerDunning> {
    return new GetByKeyRequestBuilder(CustomerDunning, {
      Customer: customer,
  ...
  getAll(): GetAllRequestBuilder<CustomerDunning> {
    return new GetAllRequestBuilder(CustomerDunning);
  }
  ...
  create(entity: CustomerDunning): CreateRequestBuilder<CustomerDunning> {
    return new CreateRequestBuilder(CustomerDunning, entity);
  }
  ...
  update(entity: CustomerDunning): UpdateRequestBuilder<CustomerDunning> {
    return new UpdateRequestBuilder(CustomerDunning, entity);
  }
  ...
  delete(customerOrEntity: any, companyCode?: string, dunningArea?: string): DeleteRequestBuilder<CustomerDunning> {
    return new DeleteRequestBuilder(CustomerDunning, customerOrEntity instanceof CustomerDunning ? customerOrEntity : {
