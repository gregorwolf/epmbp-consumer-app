 ...
 */
export class SupplierCompany extends Entity implements SupplierCompanyType {
  /**
  ...
  static builder(): EntityBuilderType<SupplierCompany, SupplierCompanyTypeForceMandatory> {
    return Entity.entityBuilder(SupplierCompany);
  }
  ...
  static customField(fieldName: string): CustomField<SupplierCompany> {
    return Entity.customFieldSelector(fieldName, SupplierCompany);
  }
...
export namespace SupplierCompany {
   ...
   */
  export const SUPPLIER: StringField<SupplierCompany> = new StringField('Supplier', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[companyCode]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const COMPANY_CODE: StringField<SupplierCompany> = new StringField('CompanyCode', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[authorizationGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const AUTHORIZATION_GROUP: StringField<SupplierCompany> = new StringField('AuthorizationGroup', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[companyCodeName]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const COMPANY_CODE_NAME: StringField<SupplierCompany> = new StringField('CompanyCodeName', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[paymentBlockingReason]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PAYMENT_BLOCKING_REASON: StringField<SupplierCompany> = new StringField('PaymentBlockingReason', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[supplierIsBlockedForPosting]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const SUPPLIER_IS_BLOCKED_FOR_POSTING: BooleanField<SupplierCompany> = new BooleanField('SupplierIsBlockedForPosting', SupplierCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[accountingClerk]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ACCOUNTING_CLERK: StringField<SupplierCompany> = new StringField('AccountingClerk', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[accountingClerkFaxNumber]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ACCOUNTING_CLERK_FAX_NUMBER: StringField<SupplierCompany> = new StringField('AccountingClerkFaxNumber', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[accountingClerkPhoneNumber]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ACCOUNTING_CLERK_PHONE_NUMBER: StringField<SupplierCompany> = new StringField('AccountingClerkPhoneNumber', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[supplierClerk]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const SUPPLIER_CLERK: StringField<SupplierCompany> = new StringField('SupplierClerk', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[supplierClerkUrl]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const SUPPLIER_CLERK_URL: StringField<SupplierCompany> = new StringField('SupplierClerkURL', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[paymentMethodsList]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PAYMENT_METHODS_LIST: StringField<SupplierCompany> = new StringField('PaymentMethodsList', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[paymentTerms]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PAYMENT_TERMS: StringField<SupplierCompany> = new StringField('PaymentTerms', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[clearCustomerSupplier]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CLEAR_CUSTOMER_SUPPLIER: BooleanField<SupplierCompany> = new BooleanField('ClearCustomerSupplier', SupplierCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[isToBeLocallyProcessed]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const IS_TO_BE_LOCALLY_PROCESSED: BooleanField<SupplierCompany> = new BooleanField('IsToBeLocallyProcessed', SupplierCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[itemIsToBePaidSeparately]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ITEM_IS_TO_BE_PAID_SEPARATELY: BooleanField<SupplierCompany> = new BooleanField('ItemIsToBePaidSeparately', SupplierCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[paymentIsToBeSentByEdi]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PAYMENT_IS_TO_BE_SENT_BY_EDI: BooleanField<SupplierCompany> = new BooleanField('PaymentIsToBeSentByEDI', SupplierCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[houseBank]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const HOUSE_BANK: StringField<SupplierCompany> = new StringField('HouseBank', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[checkPaidDurationInDays]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CHECK_PAID_DURATION_IN_DAYS: BigNumberField<SupplierCompany> = new BigNumberField('CheckPaidDurationInDays', SupplierCompany, 'Edm.Decimal');
  /**
   * Static representation of the [[currency]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CURRENCY: StringField<SupplierCompany> = new StringField('Currency', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[billOfExchLmtAmtInCoCodeCrcy]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const BILL_OF_EXCH_LMT_AMT_IN_CO_CODE_CRCY: BigNumberField<SupplierCompany> = new BigNumberField('BillOfExchLmtAmtInCoCodeCrcy', SupplierCompany, 'Edm.Decimal');
  /**
   * Static representation of the [[supplierClerkIdBySupplier]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const SUPPLIER_CLERK_ID_BY_SUPPLIER: StringField<SupplierCompany> = new StringField('SupplierClerkIDBySupplier', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[reconciliationAccount]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const RECONCILIATION_ACCOUNT: StringField<SupplierCompany> = new StringField('ReconciliationAccount', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[interestCalculationCode]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const INTEREST_CALCULATION_CODE: StringField<SupplierCompany> = new StringField('InterestCalculationCode', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[interestCalculationDate]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const INTEREST_CALCULATION_DATE: DateField<SupplierCompany> = new DateField('InterestCalculationDate', SupplierCompany, 'Edm.DateTime');
  /**
   * Static representation of the [[intrstCalcFrequencyInMonths]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const INTRST_CALC_FREQUENCY_IN_MONTHS: StringField<SupplierCompany> = new StringField('IntrstCalcFrequencyInMonths', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[supplierHeadOffice]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const SUPPLIER_HEAD_OFFICE: StringField<SupplierCompany> = new StringField('SupplierHeadOffice', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[alternativePayee]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const ALTERNATIVE_PAYEE: StringField<SupplierCompany> = new StringField('AlternativePayee', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[layoutSortingRule]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LAYOUT_SORTING_RULE: StringField<SupplierCompany> = new StringField('LayoutSortingRule', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[aparToleranceGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const APAR_TOLERANCE_GROUP: StringField<SupplierCompany> = new StringField('APARToleranceGroup', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[supplierCertificationDate]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const SUPPLIER_CERTIFICATION_DATE: DateField<SupplierCompany> = new DateField('SupplierCertificationDate', SupplierCompany, 'Edm.DateTime');
  /**
   * Static representation of the [[supplierAccountNote]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const SUPPLIER_ACCOUNT_NOTE: StringField<SupplierCompany> = new StringField('SupplierAccountNote', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[withholdingTaxCountry]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const WITHHOLDING_TAX_COUNTRY: StringField<SupplierCompany> = new StringField('WithholdingTaxCountry', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[deletionIndicator]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const DELETION_INDICATOR: BooleanField<SupplierCompany> = new BooleanField('DeletionIndicator', SupplierCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[cashPlanningGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CASH_PLANNING_GROUP: StringField<SupplierCompany> = new StringField('CashPlanningGroup', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[isToBeCheckedForDuplicates]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const IS_TO_BE_CHECKED_FOR_DUPLICATES: BooleanField<SupplierCompany> = new BooleanField('IsToBeCheckedForDuplicates', SupplierCompany, 'Edm.Boolean');
  /**
   * Static representation of the [[minorityGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const MINORITY_GROUP: StringField<SupplierCompany> = new StringField('MinorityGroup', SupplierCompany, 'Edm.String');
  /**
   * Static representation of the [[supplierAccountGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const SUPPLIER_ACCOUNT_GROUP: StringField<SupplierCompany> = new StringField('SupplierAccountGroup', SupplierCompany, 'Edm.String');
  /**
   ...
   */
  export const _allFields: Array<StringField<SupplierCompany> | BooleanField<SupplierCompany> | BigNumberField<SupplierCompany> | DateField<SupplierCompany> | Link<SupplierCompany, SupplierCompanyText> | OneToOneLink<SupplierCompany, Supplier> | Link<SupplierCompany, SupplierDunning> | Link<SupplierCompany, SupplierWithHoldingTax>> = [
   ...
   */
  export const _keyFields: Array<Field<SupplierCompany>> = [SupplierCompany.SUPPLIER, SupplierCompany.COMPANY_CODE];
  /**
   * Mapping of all key field names to the respective static field property SupplierCompany.
   */
  export const _keys: { [keys: string]: Field<SupplierCompany> } = SupplierCompany._keyFields.reduce((acc: { [keys: string]: Field<SupplierCompany> }, field: Field<SupplierCompany>) => {
