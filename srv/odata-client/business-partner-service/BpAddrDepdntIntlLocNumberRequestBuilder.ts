 ...
 */
export class BpAddrDepdntIntlLocNumberRequestBuilder extends RequestBuilder<BpAddrDepdntIntlLocNumber> {
  /**
  ...
  getByKey(businessPartner: string, addressId: string): GetByKeyRequestBuilderV2<BpAddrDepdntIntlLocNumber> {
    return new GetByKeyRequestBuilderV2(BpAddrDepdntIntlLocNumber, {
  ...
  getAll(): GetAllRequestBuilderV2<BpAddrDepdntIntlLocNumber> {
    return new GetAllRequestBuilderV2(BpAddrDepdntIntlLocNumber);
  }
  ...
  create(entity: BpAddrDepdntIntlLocNumber): CreateRequestBuilderV2<BpAddrDepdntIntlLocNumber> {
    return new CreateRequestBuilderV2(BpAddrDepdntIntlLocNumber, entity);
  }
  ...
  update(entity: BpAddrDepdntIntlLocNumber): UpdateRequestBuilderV2<BpAddrDepdntIntlLocNumber> {
    return new UpdateRequestBuilderV2(BpAddrDepdntIntlLocNumber, entity);
  }
  ...
  delete(businessPartnerOrEntity: any, addressId?: string): DeleteRequestBuilderV2<BpAddrDepdntIntlLocNumber> {
    return new DeleteRequestBuilderV2(BpAddrDepdntIntlLocNumber, businessPartnerOrEntity instanceof BpAddrDepdntIntlLocNumber ? businessPartnerOrEntity : {
