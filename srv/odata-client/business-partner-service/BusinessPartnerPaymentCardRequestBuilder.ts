 ...
 */
export class BusinessPartnerPaymentCardRequestBuilder extends RequestBuilder<BusinessPartnerPaymentCard> {
  /**
  ...
  getByKey(businessPartner: string, paymentCardId: string, paymentCardType: string, cardNumber: string): GetByKeyRequestBuilderV2<BusinessPartnerPaymentCard> {
    return new GetByKeyRequestBuilderV2(BusinessPartnerPaymentCard, {
  ...
  getAll(): GetAllRequestBuilderV2<BusinessPartnerPaymentCard> {
    return new GetAllRequestBuilderV2(BusinessPartnerPaymentCard);
  }
  ...
  create(entity: BusinessPartnerPaymentCard): CreateRequestBuilderV2<BusinessPartnerPaymentCard> {
    return new CreateRequestBuilderV2(BusinessPartnerPaymentCard, entity);
  }
  ...
  update(entity: BusinessPartnerPaymentCard): UpdateRequestBuilderV2<BusinessPartnerPaymentCard> {
    return new UpdateRequestBuilderV2(BusinessPartnerPaymentCard, entity);
  }
  ...
  delete(businessPartnerOrEntity: any, paymentCardId?: string, paymentCardType?: string, cardNumber?: string): DeleteRequestBuilderV2<BusinessPartnerPaymentCard> {
    return new DeleteRequestBuilderV2(BusinessPartnerPaymentCard, businessPartnerOrEntity instanceof BusinessPartnerPaymentCard ? businessPartnerOrEntity : {
