 ...
 */
export class SupplierDunning extends Entity implements SupplierDunningType {
  /**
  ...
  static builder(): EntityBuilderType<SupplierDunning, SupplierDunningTypeForceMandatory> {
    return Entity.entityBuilder(SupplierDunning);
  }
  ...
  static customField(fieldName: string): CustomField<SupplierDunning> {
    return Entity.customFieldSelector(fieldName, SupplierDunning);
  }
...
export namespace SupplierDunning {
   ...
   */
  export const SUPPLIER: StringField<SupplierDunning> = new StringField('Supplier', SupplierDunning, 'Edm.String');
  /**
   * Static representation of the [[companyCode]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const COMPANY_CODE: StringField<SupplierDunning> = new StringField('CompanyCode', SupplierDunning, 'Edm.String');
  /**
   * Static representation of the [[dunningArea]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const DUNNING_AREA: StringField<SupplierDunning> = new StringField('DunningArea', SupplierDunning, 'Edm.String');
  /**
   * Static representation of the [[dunningBlock]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const DUNNING_BLOCK: StringField<SupplierDunning> = new StringField('DunningBlock', SupplierDunning, 'Edm.String');
  /**
   * Static representation of the [[dunningLevel]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const DUNNING_LEVEL: StringField<SupplierDunning> = new StringField('DunningLevel', SupplierDunning, 'Edm.String');
  /**
   * Static representation of the [[dunningProcedure]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const DUNNING_PROCEDURE: StringField<SupplierDunning> = new StringField('DunningProcedure', SupplierDunning, 'Edm.String');
  /**
   * Static representation of the [[dunningRecipient]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const DUNNING_RECIPIENT: StringField<SupplierDunning> = new StringField('DunningRecipient', SupplierDunning, 'Edm.String');
  /**
   * Static representation of the [[lastDunnedOn]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LAST_DUNNED_ON: DateField<SupplierDunning> = new DateField('LastDunnedOn', SupplierDunning, 'Edm.DateTime');
  /**
   * Static representation of the [[legDunningProcedureOn]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const LEG_DUNNING_PROCEDURE_ON: DateField<SupplierDunning> = new DateField('LegDunningProcedureOn', SupplierDunning, 'Edm.DateTime');
  /**
   * Static representation of the [[dunningClerk]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const DUNNING_CLERK: StringField<SupplierDunning> = new StringField('DunningClerk', SupplierDunning, 'Edm.String');
  /**
   * Static representation of the [[authorizationGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const AUTHORIZATION_GROUP: StringField<SupplierDunning> = new StringField('AuthorizationGroup', SupplierDunning, 'Edm.String');
  /**
   * Static representation of the [[supplierAccountGroup]] property for query construction.
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const SUPPLIER_ACCOUNT_GROUP: StringField<SupplierDunning> = new StringField('SupplierAccountGroup', SupplierDunning, 'Edm.String');
  /**
   * All fields of the SupplierDunning entity.
   */
  export const _allFields: Array<StringField<SupplierDunning> | DateField<SupplierDunning>> = [
   ...
   */
  export const _keyFields: Array<Field<SupplierDunning>> = [SupplierDunning.SUPPLIER, SupplierDunning.COMPANY_CODE, SupplierDunning.DUNNING_AREA];
  /**
   * Mapping of all key field names to the respective static field property SupplierDunning.
   */
  export const _keys: { [keys: string]: Field<SupplierDunning> } = SupplierDunning._keyFields.reduce((acc: { [keys: string]: Field<SupplierDunning> }, field: Field<SupplierDunning>) => {
